...
namespace Examples.Tutorial
{
    ...
    public class T08_VBO : GameWindow
    {
        ...
        void Keyboard_KeyDown(object sender, KeyboardKeyEventArgs eventArgs)
        {
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            string xxx = GL.GetString(StringName.Extensions);
...
//            GL.Enable(EnableCap.Lighting);
            ...
            //Bitmap bitmap = new Bitmap("C:/Users/Miguel/Documents/OpenTK/1.0/Source/Examples/Data/Textures/logo.jpg");
