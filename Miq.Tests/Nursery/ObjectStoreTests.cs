...
namespace Miq.Tests.Nursery
{
    ...
    class ObjectStore
    {
        ...
        {
            // ZZZ don't hardcode the drive letter
            // ZZZ don't fail if direcory doesn't exists
            string directory = Path.Combine(
                                        @"E:\Stuff\KindleCompare\ObjectStore",
                                        sha1.Substring(0, 2));
    ...
    public class ObjectStoreTests
    {
        ...
        {
            // ZZZ don't hardcode the drive name
            // ZZZ don't assume the directory is going to exist
            string path = @"E:\Temp\System";
